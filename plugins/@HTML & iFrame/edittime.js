function GetPluginSettings()
{
	return {
		...
		"id":				"HTML_iFrame",
		"version":			"1.42",
		"description":		"在Construct 2中引入iFrame.",
		"author":			"PlayLive",
...
////////////////////////////////////////
// 条件
AddStringParam("CSS文件名", "要比较的CSS文件名.");
AddCondition(0, cf_none, "比较CSS文件名", "Appearance", "要比较的CSS文件 <i>{0}</i>", "比较导入的CSS文件名.", "CompareCSSfilename");

AddStringParam("CSS样式", "进行比较的CSS样式.");
AddCondition(1, cf_none, "比较CSS样式", "Appearance", "要比较的CSS样式 <i>{0}</i>", "比较当前在此对象中显示的CSS样式.", "CompareCSSstyle");
...
var property_list = [
/* [00] */	new cr.Property(ept_text,	"ID (Optional)",		"",						"控件的ID，允许使用页面HTML中的CSS对其进行样式设置."),
/* [01] */	new cr.Property(ept_text,	"Class (Optional)",		"",					"控件的类，允许使用页面HTML中的CSS对其进行样式设置."),
/* [02] */	new cr.Property(ept_combo,	"Initial visibility",	"Visible",			"选择此对象在启动时是否可见.", "Invisible|Visible"),
/* [03] */	new cr.Property(ept_text,	"Tooltip",				"",					"将鼠标悬停在控件上时显示的文本."),
/* [04] */	new cr.Property(ept_text,	"Background",			"", 				"此对象的背景色.\n例如：rgb(255, 255, 255)"),
/* [05] */	new cr.Property(ept_text,	"Border",				"",					"此对象边框样式.\n例如：3px solid rgb(255, 255, 255)"),
/* [06] */	new cr.Property(ept_combo,	"Scroll",				"Auto",				"此对象是否具有滚动条.\nNo:无\nAuto:自动\nHorizontal:水平\nVertical:垂直", "No|Auto|Horizontal|Vertical"),
/* [07] */	new cr.Property(ept_combo,	"Object",				"iFrame",			"选择对象为 'iFrame' 或 'HTML'\niFrame:外部网址\nHTML:内嵌HTML代码.", "iFrame|HTML"),
/* [--] */	new cr.Property(ept_section,"iFrame",				"",					""),
/* [08] */	new cr.Property(ept_text,	"URL",					"",					"iFrame的URL.\n例如：https://www.baidu.com/\n使用Chrome可能提示跨域错误，用NW.JS就可以了"),
/* [--] */	new cr.Property(ept_section,"HTML",					"",					""),
/* [09] */	new cr.Property(ept_text,	"Code",					"",					"HTML代码.\n例如：<h1>Hello World</h1>"),
/* [10] */	new cr.Property(ept_text,	"Color",				"",					"HTML的颜色.\n例如：rgb(255, 255, 255)或#f00"),
/* [11] */	new cr.Property(ept_combo,	"Text selectable",		"Yes",				"是否可以选择文本.","No|Yes"),
/* [12] */	new cr.Property(ept_combo,	"Auto font size",		"Default",			"自动设置字体大小.", "No|Default|Small|Big|Large"),
/* [--] */	new cr.Property(ept_section,"导入",				"",					""),
/* [13] */	new cr.Property(ept_text,	"CSS import",			"",					"要导入的外部CSS文件的名称，以分号分隔.\n例如：style-01.css; style-02.css"),
/* [14] */	new cr.Property(ept_text,	'Javascript import',	"",					"要导入的外部Javascript的名称，以分号分隔.\n例如：script-01.js; script-02.js")
];
