...
(function ()
{
	...
	instanceProto.onCreate = function()
	{
		...
		this.Region = ["EU", "US", "Asia", "JP", "AU"][this.properties[3]];
		this.LogLevel = this.properties[4] + Exitgames["Common"]["Logger"]["Level"]["DEBUG"];
	...
	Acts.prototype.subscribe = function (channelNames, historyLeength)
	{
		this.chatClient["subscribe"](channelNames.split(","), historyLeength);
	};
