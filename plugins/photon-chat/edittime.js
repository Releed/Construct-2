...
AddCondition(31, cf_trigger, "On connected to Front End", "Connection", "onConnectedToFrontEnd", "Triggered when client connects to Front End and ready to chat.", "onConnectedToFrontEnd");

AddCondition(41, ef_none, "Is connected to Nameserver", "Connection", "Is connected to Nameserver", "True if client connected to Nameserver.", "isConnectedToNameServer");
AddCondition(42, ef_none, "Is connected to Front End", "Connection", "Is connected to Front End server", "True if client connected to Front End server.", "isConnectedToFrontEnd");
...
AddAction(21, af_none, "Subscribe", "Chat", "Subscribe to channels <b>{0}</b>", "Subscribe to channels.", "subscribe");
AddStringParam("Channels", "Comma-separated list of channels.");
...
AddAction(31, af_none, "Publish message", "Chat", "Send message to public channel <b>{0}</b>", "Send message to a public channel.", "publishMessage");
AddStringParam("UserId", "User id.");
AddStringParam("Message", "Message.");
AddAction(32, af_none, "Send private message", "Chat", "Send private message to user <b>{0}</b>", "Send private message to a single target user.", "sendPrivateMessage");
...
AddAction(51, af_none, "Set user status", "Chat", "Set user's status to <b>{0}</b>", "Set user's status and an optional message.", "setUserStatus");
...
var property_list = [
	...
	new cr.Property(ept_combo, 	"Region",				"EU",				"Master server region.", "EU|US|Asia|JP|AU"),
