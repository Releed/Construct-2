function GetPluginSettings()
{
	return {
		...
		"id":			"AJAX",
		"version":		"1.0",
		"description":	"请求和接收其他网页. 必须允许跨域请求才能在localhost中预览（推荐NW.JS）",
		"author":		"Scirra",
...
//////////////////////////////////////////////////////////////
// Conditions
AddStringParam("Tag", "设置一个标签,用来区分不同的AJAX请求.", "\"\"");
...
//////////////////////////////////////////////////////////////
// Expressions
AddExpression(0, ef_return_string, "Get last data", "AJAX", "LastData", "获取上一个成功请求返回的数据.");
AddExpression(1, ef_return_number, "Get progress", "AJAX", "Progress", "Get the progress, from 0 to 1, of the request in 'On progress'.");
AddExpression(2, ef_return_string, "", "AJAX", "Tag", "在触发器中获取请求的标签.");
