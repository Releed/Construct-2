...
AddCondition(12, cf_deprecated, "Action Point exists on frame", "Action Points", "Action Point {0} exists on current frame", "True when the action point exists on the current frame", "actionPointExists");
...
AddStringParam("object name", "The name of the sprite, bone, sound, etc to check for a tag.  Leave blank for universal tags (the object's name in Spriter, not the name of the C2 object)");
...
AddStringParam("name", "The name of the object.");
AddCondition(17, 0, "Object exists on frame", "Objects", "Object {0} exists on current frame", "True when the action object exists on the current frame", "objectExists");
...
AddStringParam("Object Name", "The name of the sprite, bone, sound, etc to override animation for (the object's name in Spriter, not the name of the C2 object)");
AddComboParamOption("angle");
AddComboParamOption("x");
AddComboParamOption("y");
AddComboParamOption("scale x");
AddComboParamOption("scale y");
AddComboParamOption("image frame");
AddComboParamOption("pivot x");
AddComboParamOption("pivot y");
AddComboParamOption("entity index");
AddComboParamOption("animation index");
AddComboParamOption("time ratio");
AddComboParam("Override Component", "The component value you want to override", 0);
AddNumberParam("Value","New component value","0");
AddAction(19, 0, "Override Object Animation", "Override Animation", "Override object {0}'s {1} with {2}", "Override an object's animation data.","overrideObjectComponent");

AddStringParam("Parent Bone Name", "The name of the parent bone you want to use IK on");
AddStringParam("Child Bone Name", "The name of the child bone you want to use IK on");
AddNumberParam("Target X","X location you want the IK joint to reach for","0");
AddNumberParam("Target Y","Y location you want the IK joint to reach for","0");
AddNumberParam("Additional child bone length","Additional child bone length","0");
AddAction(20, 0, "Override Bones With IK", "Override Animation", "Override bones {0} and {1} with IK to ({2},{3}) with child bone extended by {4}", "Use IK to override bones' animation data.","overrideBonesWithIk");

AddObjectParam("C2 Object", "Choose the C2 Object you want to set to a Spriter Object");
AddComboParamOption("angle and position");
AddComboParamOption("angle");
AddComboParamOption("position");
AddComboParam("Set which properties", "The properties you want to set to the Spriter Object", 0);
AddStringParam("Spriter Object", "The Spriter Object you want to set it to");
AddAction(21, 0, "Set C2 Object to Spriter Object", "Attach C2 Object", "Set {0}'s {1} to {2}", "Set C2 Object's angle and/or position to Spriter Object.","setC2ObjectToSpriterObject");

AddComboParamOption("don't ignore layout time scale");		
AddComboParamOption("ignore layout time scale");	
AddComboParam("Ignore layout time scale?", "Set whether or not to ignore the global time scale of the current layout", 1);
AddAction(22, 0, "Set ignore layout time scale", "Misc", "Set {0}", "Set whether or not to ignore the global time scale of the current layout.","setIgnoreGlobalTimeScale");

AddObjectParam("C2 Object", "Choose the C2 Object you want to find the corresponding Spriter Object of");
AddAction(23, 0, "Find Spriter Object from C2 Object", "Objects", "Find Spriter Object for {0}", "Find Spriter Object that corresponds with the C2 Object (retrieve with expression 'foundObject'.","findSpriterObject");

AddComboParamOption("Stop");		
AddComboParamOption("Resume");	
AddComboParam("Set Sprite Layers", "Choose whether to stop or resume setting layers for individual sprites", 0);
AddAction(24, 0, "Stop/Resume Setting Sprite Layer", "Misc", "{0} setting sprite layers", "Stop or resume setting layer to allow you to override them","stopResumeSettingLayer");
...
AddComboParam("Set which properties", "The properties you want to set to the Spriter Object", 0);
AddStringParam("Spriter Object", "The Spriter Object you want to set it to");
AddAction(27, 0, "Pin C2 Object to Spriter Object", "Attach C2 Object", "Pin {0}'s {1} to {2}", "Pin C2 Object's angle and/or position to Spriter Object.","pinC2ObjectToSpriterObject");

AddObjectParam("C2 Object", "Choose the C2 Object you want to set to a Spriter Object");
AddStringParam("Spriter Object", "The Spriter Object you want to set it to. Leave empty string for all objects");
AddAction(25, 0, "Unpin C2 Object from Spriter Object", "Attach C2 Object", "Unpin {0} from {1}", "Unpin C2 Object from Spriter Object.","unpinC2ObjectFromSpriterObject");

AddStringParam("Spriter Object", "The Spriter Object you want to set it to. Leave empty string for all objects");
AddAction(26, 0, "Unpin all from Spriter Object", "Attach C2 Object", "Unpin all objects from {0}", "Unpin all C2 Object from Spriter Object.","unpinAllFromSpriterObject");
...
AddStringParam("name", "The name of the point.");
AddExpression(8, ef_return_number|ef_deprecated, "Action Point X", "Action Points", "pointX", "returns the current x position of an action point");

AddStringParam("name", "The name of the point.");
AddExpression(9, ef_return_number|ef_deprecated, "Action Point Y", "Action Points", "pointY", "returns the current y position of an action point");

AddStringParam("name", "The name of the point.");
AddExpression(10, ef_return_number|ef_deprecated, "Action Point Angle", "Action Points", "pointAngle", "returns the current angle of an action point");
...
AddExpression(17, ef_return_any|ef_variadic_parameters, "Spriter Variable Value", "Tags and Variables", "val", "returns the currentValue of the Spriter variable (variable name, object name) (the object's name in Spriter, not the name of the C2 object)");
...
AddStringParam("name", "The name of the object.");
AddExpression(19, ef_return_number, "Object X", "Objects", "objectX", "returns the current x position of an object");

AddStringParam("name", "The name of the object.");
AddExpression(20, ef_return_number, "Object Y", "Objects", "objectY", "returns the current y position of an object");

AddStringParam("name", "The name of the object.");
AddExpression(21, ef_return_number, "Object Angle", "Objects", "objectAngle", "returns the current angle of an object");

AddExpression(22, ef_return_number, "Current animation's length in milliseconds (at normal playback speed)", "Animations", "animationLength", "Returns the of the current animation in milliseconds (at normal playback speed)");

AddExpression(23, ef_return_number, "Current playback speed ratio", "Animations", "speedRatio", "Returns the current playback speed ratio (1.0 is full speed. 0.5 is half speed, 2.0 is double speed)");

AddExpression(24, ef_return_number, "Bounding Box Left", "Size & Position", "BBoxLeft", "Get the left edge of the object's bounding box, in pixels.");
AddExpression(25, ef_return_number, "Bounding Box Right", "Size & Position", "BBoxRight", "Get the right edge of the object's bounding box, in pixels.");
AddExpression(26, ef_return_number, "Bounding Box Top", "Size & Position", "BBoxTop", "Get the top edge of the object's bounding box, in pixels.");
AddExpression(27, ef_return_number, "Bounding Box Bottom", "Size & Position", "BBoxBottom", "Get the bottom edge of the object's bounding box, in pixels.");
AddExpression(28, ef_return_string, "Name of last found Object", "Objects", "foundObject", "returns the name of the last found object (Find Spriter Object action)");
...
var property_list = [
	//new cr.Property(ept_integer, 	"My property",		77,		"An example property."),
	 ...
	 new cr.Property(ept_float,		"starting opacity", "100","The starting opacity, from 0 (transparent) to 100(opaque)"),
	 new cr.Property(ept_combo,		"draw self",	"false",	"Plugin draws it's own images.",	"false|true"),
	 new cr.Property(ept_text,		"nickname in c2",	"",	"The name displayed within the C2 editor instead of the filename"),
	];
...
IDEInstance.prototype.OnPropertyChanged = function(property_name)
{
	...
	if(property_name=="nickname in c2")
	{
		this.objectName=this.properties["nickname in c2"];
	}
	
	if(!this.objectName)
	{
		this.objectName=this.properties["SCML file"];;
	}
}
...
IDEInstance.prototype.Draw = function(renderer)
{
	...
	this.font.DrawText(this.objectName+"\n"+this.instance.GetSize().x/50.0,quad,cr.RGB(0, 0, 0),ha_left,1,this.instance.GetAngle());
