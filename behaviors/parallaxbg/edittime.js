function GetBehaviorSettings()
{
	return {
		...
		"id": "ParallaxBG",	
		"version": "1.3.0.0",
		"description": "Parallax scrolling and screen wrapping for TiledBackground objects.",
...
AddNumberParam("Value", "The tile width.", "512");
AddAction(20, af_none, "Set Tile Width", "", "Set {my} tile width to <b>{0}</b>", "Set tile width.", "SetTileWidth");

AddNumberParam("Value", "The tile height.", "512");
AddAction(21, af_none, "Set Tile Height", "", "Set {my} tile height to <b>{0}</b>", "Set tile height.", "SetTileHeight");
